...
const EventDetails = (props) => {
    ...
    const handleUpdate = (e) => {
        ...
        axios.post(`/events/${event._id}/update`, 
                {description: description, title: title, start_time:start, end_time:end, colour: colour, importance: importance, reminder: reminder, time:(new Date(start)), contacts: contacts}).then(res => console.log(res));
